...
#[Framework\Attributes\CoversClass(Report\Deprecation::class)]
...
final class DeprecationTest extends Framework\TestCase
{
    use Test\Util\Helper;

    public function testCreateReturnsDeprecation(): void
    {
        $faker = self::faker();
        ...
        $deprecation = Report\Deprecation::create(
            $file,
            $line,
            $message,
            $triggeredBy,
        ...
        self::assertSame($file, $deprecation->file());
        self::assertSame($line, $deprecation->line());
        self::assertSame($message, $deprecation->message());
        self::assertSame($triggeredBy, $deprecation->triggeredBy());
    }
}
